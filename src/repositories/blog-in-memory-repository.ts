// import {BlogDBType, BlogInputModel, memoryBlogDBType} from "../input-output-types/blog types";
// import {db_mockup} from "./db";
//
//
// export const blogRepository = {
//     async createBlog(blog:memoryBlogDBType) : Promise<BlogDBType> {
//         const newBlog: memoryBlogDBType = {
//             _id:blog._id,
